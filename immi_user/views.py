...
class immi_user_auth():
    ...
    def profile(request):
        ...
        return render(request, 'users/profile.html', {'form' : form, 'notification': notification.objects.all().order_by('-date') })
    ...
    def change_password(request):
        ...
        return render(request, 'recoveraccount/changepassword.html', {'form' : form, 'notification': notification.objects.all().order_by('-date')})
